...
import { ShoppingBag, MessageSquare, MapPin, CheckCircle2, ShoppingCart, ExternalLink, ArrowLeft } from 'lucide-react';
      ...
      <header className="w-full bg-blue-600 text-white p-6 md:p-10 text-center relative rounded-b-[40px] shadow-xl shadow-blue-500/20 max-w-4xl">
        ...
        <div className="mt-8 flex flex-col md:flex-row items-center justify-center gap-4 text-xs font-bold text-blue-50">
           ...
           <a 
             ...
             className="flex items-center gap-2 px-4 py-2 bg-green-500 rounded-full shadow-lg active:scale-95 transition-all hover:bg-green-600"
           >
      ...
      <main className="w-full max-w-2xl px-4 mt-8 space-y-6">
        ...
        <div className="grid grid-cols-1 gap-6">
          {products.map(product => (
            <div key={product.id} className="bg-white rounded-[32px] overflow-hidden shadow-md border border-slate-100 flex flex-col hover:shadow-xl transition-shadow duration-300">
              <div className="h-64 relative bg-slate-100">
                ...
                <div className="absolute top-4 right-4">
                   <div className="bg-white/90 backdrop-blur-md text-blue-600 px-4 py-2 rounded-2xl font-black text-lg shadow-xl border border-blue-50">
              ...
              <div className="p-6">
                ...
                <div className="flex items-center justify-between pt-6 border-t border-slate-50">
                  <div className="flex flex-col">
                    <span className="text-[10px] font-bold text-slate-400 uppercase tracking-tighter">Formas Aceitas</span>
                  ...
                  <button 
                    ...
                    className="flex items-center gap-2 px-6 py-3 bg-blue-600 text-white font-black rounded-2xl shadow-lg shadow-blue-500/30 active:scale-95 transition-all hover:bg-blue-700"
                  >
                    {product.externalLink ? <ExternalLink size={18} /> : <ShoppingCart size={18} />}
                    {product.externalLink ? 'SAIBA MAIS' : 'EU QUERO!'}
                  </button>
                </div>
              </div>
            </div>
